...
export const SlideContent = ({}: SlideContentProps) => {
  return (
    <div className="p-8 bg-gray-800 bg-opacity-40 rounded">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        className="block mb-4 w-5 h-5 text-gray-500"
      ...
      <a className="inline-flex items-center">
        ...
        <span className="flex flex-col flex-grow pl-4">
          <span className="text-white font-medium">Holden Caulfield</span>
          <span className="text-gray-500 text-sm uppercase">UI DEVELOPER</span>
        </span>
      </a>
    </div>
  );
